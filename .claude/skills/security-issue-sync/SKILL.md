...
- **Description fields** — if the issue body is missing any of the fields the
  ...
  **Validate this on every sync pass that proposes a body-field update
  ...
  JSON + the next push to the CVE record. When the carrier release
