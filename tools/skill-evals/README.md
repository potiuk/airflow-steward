...
- **setup** — 26 cases across 7 steps (step-verify-drift, step-overrides-surface, step-override-bypass, step-m5-no-repo-offer, step-adopt-settings-merge, verify-default-set, uninstall-default-set)
